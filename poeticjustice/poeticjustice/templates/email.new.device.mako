...
<div class="row">
    <div class="panel" style="overflow:auto;">
        <div class="large-12 columns">
                <h1 class="subheader">Connecting a new phone?</h1>
        ...
        <div>
            <table>
                <tbody>
                    <tr>
                        <td width="300">
                            <b class="size-21">New device attached to your account!</b>
                        </td>
                        <td width="300">
                    ...
                    <tr>
                        <td width="300">
                            <h4 class="subheader">
                                ...
                                Make sure your spam-blocker is configured to allow mail from 
                                <b>miga.bot@miga.com</b>.
        ...
        <div class="medium-12 columns">
            <div class="row">
                <!-- <h6><small>Save this notice for quick access to helpful links</small></h6> -->
            </div>
        </div>
